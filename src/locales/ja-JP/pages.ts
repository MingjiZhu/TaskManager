export default {
  ...
  'pages.resume.advancedComponent': '高度なコンポーネント',
  'pages.resume.link': 'ようこそ',
  'pages.resume.advancedLayout': '高度なレイアウト',
  'pages.resume.alertMessage': 'より高速で強力な頑丈なコンポーネントがリリースされました。',
